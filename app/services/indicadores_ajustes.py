...
def indicadores():
    ...
    st.caption(f"**Total de indicadores:** {len(df)}")
    ...
    if editar_btn:
        if len(seleccionados) == 0:
            st.warning(":material/warning: Selecciona un indicador para editar")
        elif len(seleccionados) > 1:
            st.warning(":material/warning: Selecciona solo un indicador para editar")
        else:
    ...
    if eliminar_btn:
        if len(seleccionados) == 0:
            st.warning(":material/warning: Selecciona al menos un indicador para eliminar")
        else:
